...
public string StrtoDeserialize;
  ...
  int iterations = 1;
     ...
     private void ReceiveCallback(IAsyncResult AR)
    {
        ...
        Painter.drawing testing = new Painter.drawing("drawingID", "geohash", "sessionID", filler,  "endOfDocument");
        Painter.drawing finalTest = new Painter.drawing("drawingID", "geohash", "sessionID", filler,  "endOfDocument");
    ...
    public string /*BsonDocument*/ setupDrawingObject(){
        ...
        massiveStringFromReports = massiveStringFromReports.Replace(", trackableIdOfPlane : ", "', 'trackableIdOfPlane' : ");
        massiveStringFromReports = massiveStringFromReports.Replace("subId1 :", "'subId1' :");
        massiveStringFromReports = massiveStringFromReports.Replace("subId2 :", "'subId2' :");
        ...
        while(massiveStringFromReports.Contains("drawingID")){
            ...
            if(isDigit == true){
               ...
               // stringToDeserialize.Replace("{ 'drawingID'","{'drawingID'");
                ...
                Painter.drawing drawingss = new Painter.drawing("drawingID", "geohash", "sessionID", filler,  "endOfDocument");
                Debug.Log("HOW");
